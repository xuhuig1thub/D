...
public class SystemEnvironmentPropertySourceEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {
    public SystemEnvironmentPropertySourceEnvironmentPostProcessor() {
        log.info(">>>Constructor-ystemEnvironmentPropertySourceEnvironmentPostProcessor()");
    }
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        log.info(">>>postProcessEnvironment(ConfigurableEnvironment, SpringApplication)-I-EnvironmentPostProcessor");
    ...
    @Override
    public int getOrder() {
        log.info("int getOrder()");
        return this.order;
    }

    public void setOrder(int order) {
        log.info("setOrder(int order)");
        this.order = order;
    }
