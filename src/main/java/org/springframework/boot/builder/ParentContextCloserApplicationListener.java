...
public class ParentContextCloserApplicationListener
    ...
    public ParentContextCloserApplicationListener() {
        log.info(">>>Constructor-ParentContextCloserApplicationListener()");
    }
    ...
    public void onApplicationEvent(ParentContextAvailableEvent event) {
        log.info(">>>onApplicationEvent(ParentContextAvailableEvent)");
        maybeInstallListenerInParent(event.getApplicationContext());
    }

    private void maybeInstallListenerInParent(ConfigurableApplicationContext child) {
        log.info(">>>maybeInstallListenerInParent(ConfigurableApplicationContext child)");
    ...
    protected static class ContextCloserListener implements ApplicationListener<ContextClosedEvent> {
        ...
        public ContextCloserListener(ConfigurableApplicationContext childContext) {
            log.info(">>>Constructor-ContextCloserListener(ConfigurableApplicationContext childContext)");
            this.childContext = new WeakReference<>(childContext);
        }

        @Override
        public void onApplicationEvent(ContextClosedEvent event) {
            log.info(">>>ContextCloserListener-onApplicationEvent(ContextClosedEvent event)");
