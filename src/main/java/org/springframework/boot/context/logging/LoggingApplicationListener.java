...
public class LoggingApplicationListener implements GenericApplicationListener {
    ...
    public LoggingApplicationListener() {
        log.info(">>>Constructor-LoggingApplicationListener()");
    }

    @Override
    public boolean supportsEventType(ResolvableType resolvableType) {
//        log.info(">>>boolean supportsEventType(ResolvableType)");
        return isAssignableFrom(resolvableType.getRawClass(), EVENT_TYPES);
    }

    @Override
    public boolean supportsSourceType(Class<?> sourceType) {
//        log.info(">>>boolean supportsSourceType(Class<?> sourceType)");
    ...
    public void onApplicationEvent(ApplicationEvent event) {
        log.info(">>>onApplicationEvent(ApplicationEvent)-I-ApplicationListener");
    ...
    protected void initialize(ConfigurableEnvironment environment, ClassLoader classLoader) {
        log.info(">>>protected void initialize(ConfigurableEnvironment, ClassLoader)");
    ...
    protected void initializeSpringBootLogging(LoggingSystem system, LogLevel springBootLogging) {
        log.info(">>>protected void initializeSpringBootLogging(LoggingSystem, LogLevel springBootLogging)");
    ...
    protected void setLogLevels(LoggingSystem system, ConfigurableEnvironment environment) {
        log.info(">>>protected void setLogLevels(LoggingSystem, ConfigurableEnvironment)");
    ...
    public void setSpringBootLogging(LogLevel springBootLogging) {
        log.info(">>>setSpringBootLogging(LogLevel springBootLogging)");
    ...
    public void setParseArgs(boolean parseArgs) {
        log.info(">>>setParseArgs(boolean parseArgs)");
