...
public class ConfigurationWarningsApplicationContextInitializer
    ...
    public ConfigurationWarningsApplicationContextInitializer() {
        log.info(">>>Constructor-ConfigurationWarningsApplicationContextInitializer()");
    }

    @Override
    public void initialize(ConfigurableApplicationContext context) {
        log.info(">>>initialize(ConfigurableApplicationContext)-I-ApplicationContextInitializer");
    ...
    protected static final class ConfigurationWarningsPostProcessor
        ...
        public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
            log.info(">>>postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory)");
        }

        @Override
        public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
            log.info(">>>postProcessBeanDefinitionRegistry(BeanDefinitionRegistry) ");
